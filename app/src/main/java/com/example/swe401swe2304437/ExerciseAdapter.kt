...
data class ExerciseItem(val title: String, val subtitle: String, var isDownloaded: Boolean)

class ExerciseAdapter(
    private val context: Context,
    private val dataSource: List<ExerciseItem>,
    private val onActionClick: (ExerciseItem) -> Unit
) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        val currentItem = getItem(position) as ExerciseItem
